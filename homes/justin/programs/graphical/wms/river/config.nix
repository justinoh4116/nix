...
in {
  config = lib.mkIf env.desktop.wms.river.enable {
    ...
    home.pointerCursor = {
      gtk.enable = true;
      name = env.desktop.cursor.name;
      package = env.desktop.cursor.package;
      size = env.desktop.cursor.size;
      x11 = {
        defaultCursor = env.desktop.cursor.name;
        enable = true;
      };
    };
    ...
    in {
      ...
      in {
        ...
        xcursor-theme = env.desktop.cursor.name;
        set-repeat = "50 300";
